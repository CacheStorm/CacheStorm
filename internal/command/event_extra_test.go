...
func TestEventCommandsCOMPRESSFullCoverage(t *testing.T) {
	...
	tests := []struct {
		...
		{"COMPRESS.GUNZIP valid", "COMPRESS.GUNZIP", [][]byte{{0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xcb, 0x48, 0xcd, 0xc9, 0xc9, 0x07, 0x00, 0x86, 0xa6, 0x10, 0x36, 0x05, 0x00, 0x00, 0x00}}},
		...
		{"COMPRESS.INFLATE valid", "COMPRESS.INFLATE", [][]byte{{0x78, 0x9c, 0xcb, 0x48, 0xcd, 0xc9, 0xc9, 0x07, 0x00, 0x00, 0x00, 0xff, 0xff}}},
		...
		{"COMPRESS.UNZLIB valid", "COMPRESS.UNZLIB", [][]byte{{0x78, 0x9c, 0xcb, 0x48, 0xcd, 0xc9, 0xc9, 0x07, 0x00, 0x00, 0x00, 0xff, 0xff}}},
