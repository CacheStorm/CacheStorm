...
func cmdSTATSALL(ctx *Context) error {
	...
	results := []*resp.Value{
		...
		resp.IntegerValue(mapInt64(metrics, "uptime_seconds")),
		resp.BulkString("total_connections"),
		resp.IntegerValue(mapInt64(metrics, "total_connections")),
		resp.BulkString("active_connections"),
		resp.IntegerValue(mapInt64(metrics, "active_connections")),
		resp.BulkString("total_commands"),
		resp.IntegerValue(mapInt64(metrics, "total_commands")),
		resp.BulkString("total_reads"),
		resp.IntegerValue(mapInt64(metrics, "total_reads")),
		resp.BulkString("total_writes"),
		resp.IntegerValue(mapInt64(metrics, "total_writes")),
		resp.BulkString("total_hits"),
		resp.IntegerValue(mapInt64(metrics, "total_hits")),
		resp.BulkString("total_misses"),
		resp.IntegerValue(mapInt64(metrics, "total_misses")),
		...
		resp.IntegerValue(mapInt64(metrics, "bytes_in")),
		resp.BulkString("bytes_out"),
		resp.IntegerValue(mapInt64(metrics, "bytes_out")),
	}
